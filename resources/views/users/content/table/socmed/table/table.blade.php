@include ('admin.assets.headers')
        ...
        <div class="mdk-drawer-layout js-mdk-drawer-layout"
            ...
            <div class="mdk-drawer-layout__content page-content">
                ...
                <div class="container-fluid page__container">
                    ...
                    <!--overview-->
                    @include ('users.content.table.socmed.overview')
                    <!--endoverview-->

                    <!--overview-->
                    @include ('users.content.table.socmed.table.team')
                    <!--endoverview-->

                        <div class="page-separator">
                            <div class="page-separator__text">My Tasks</div>
                        </div>
    ...
    <div class="tab-pane fade show active"
        ...
        <div class="table-responsive">
            @include ('users.content.table.socmed.table.active')
        </div>
    ...
    <div class="tab-pane fade show fade"
        ...
        <div class="table-responsive">
            @include ('users.content.table.socmed.table.month')
        </div>
    ...
    <div class="tab-pane fade show fade"
        ...
        <div class="table-responsive">
            @include ('users.content.table.socmed.table.list')
        </div>
    ...
    <div class="tab-pane fade"
        ...
        <div class="table-responsive">
           @include ('users.content.table.socmed.table.archive')
        </div>
