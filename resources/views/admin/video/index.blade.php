@include ('admin.assets.headers')
 ...
 @include ('admin.video.newtaskmodal')
 <!--pop-up for active  -->
                      @include ('admin.video.viewpop')
        <div class="mdk-drawer-layout js-mdk-drawer-layout"
            ...
            <div class="mdk-drawer-layout__content page-content">
                ...
                <div class="container-fluid page__container">
                    ...
                    <!--overview-->
                    @include ('admin.video.overview')
                    <!--endoverview-->

                      <!--overview-->
                    @include ('admin.video.table.team')
                    <!--endoverview-->
  ...
  <script>
    ...
    <div class="tab-pane fade show active"
        ...
        <div class="table-responsive">
            @include ('admin.video.table.active')
        </div>
    ...
    <div class="tab-pane fade show fade"
        ...
        <div class="table-responsive">
            @include ('admin.video.table.month')
        </div>
    ...
    <div class="tab-pane fade show fade"
        ...
        <div class="table-responsive">
            @include ('admin.video.table.event')
        </div>
    ...
    <div class="tab-pane fade show fade"
        ...
        <div class="table-responsive">
            @include ('admin.video.table.list')
        </div>
    ...
    <div class="tab-pane fade"
        ...
        <div class="table-responsive">
           @include ('admin.video.table.archive')
        </div>
